...
1. **บันทึกสำรองหลังบ้าน (Markdown):** บันทึกเป็นไฟล์ `.md` ยอดนิยมไว้ที่ `WTJ_Content_Studio/Team_Agent_Content/workspace/2_drafts/` เพื่อเป็นสำรองข้อมูลหลังบ้าน
...
./venv/bin/python3 WTJ_Content_Studio/Team_Agent_Content/skills/fb_draft_generator.py
```
> [!TIP]
