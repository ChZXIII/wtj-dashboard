...
# Constants
CSV_PATH = os.path.join(PROJECT_ROOT, "WTJ_Content_Studio", "Team_Agent_Content", "WTJ_Story_Project", "workspace", "1_raw_materials", "analytics", "Table data.csv")
STATE_PATH = os.path.join(PROJECT_ROOT, "WTJ_Content_Studio", "Team_Agent_Content", "workspace", "rerun_state.json")
DRAFTS_DIR = os.path.join(PROJECT_ROOT, "WTJ_Content_Studio", "Team_Agent_Content", "workspace", "2_drafts")
...
def main():
    ...
    for v in target_videos:
        ...
        if transcript_text and len(transcript_text.strip()) >= 50:
            ...
            temp_audio_path = os.path.join(PROJECT_ROOT, "WTJ_Content_Studio", "Team_Agent_Content", "workspace", temp_audio_filename)
