...
RECOVERED_INCOME_ROWS: List[List[Any]] = [
    ...
    [
        ...
        "ถ่ายภาพนิ่ง และ VDO พร้อมตัดต่อ",
        29000.0,
        2030.0,
        31030.0,
        3.0,
        ...
        "ชำระเงินแล้ว",
        "23/06/2026",
        "คนทำงาน: เก่ง, พี่นิค | หัก บ.: เก่ง ฿2,000.00, พี่นิค ฿2,000.00 (รวม ฿4,000.00)",
        "-",
        "เก่ง",
        "-",
        0.0,
    ...
    [
        ...
        format_branch_for_sheet("00000"),
        "บริการผลิตสื่อและโปรดักชั่น VTR AOT (ผลิต VTR AOT)",
        50000.0,
        3500.0,
        53500.0,
        3.0,
        ...
        "https://drive.google.com/file/d/10sYppBBP3SXgmcIwLNIlMJWxMnn_RN5G/view?usp=drivesdk",
        "เลขาเฟิส (GHN168 LINE Bot)",
        "ผลิต VTR AOT",
        0.0,
        "-"
