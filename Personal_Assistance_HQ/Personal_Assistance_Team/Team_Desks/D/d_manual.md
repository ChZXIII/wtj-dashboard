...
- **การออกแบบแดชบอร์ดพอร์ตคริปโต (Version 2.5.7):**
  - *สไตล์:* Brutalist ขอบเส้นดำคม เงาสามมิติทึบเฉียงขวาล่าง 4px ขอบมน 12px พื้นหลังเป็นกระจกฝ้า (frosted glass)
  - *ข้อจำกัด:* ห้ามใช้อีโมจิเด็ดขาดบน UI (ใช้ SVG/Text เปล่าเท่านั้น), ห้ามใช้ฟอนต์ `Share Tech Mono` แสดงผลทั่วไปบน UI, แยกการแสดงผล BTC (ของฉัน/ของมด) และ KUB (ของธาม) เป็นแถวอิสระ และคุมธีมสีชมพูเรืองแสงพาสเทลคงที่ 100% แบบออฟไลน์ ห้าม push ขึ้นรีโมท
